package adriengervais.dandy.adapters;
...
public class ActivityMainListViewAdapter extends ArrayAdapter<Character> {
    List<Character> modelItems = null;
    Context context;
    public ActivityMainListViewAdapter(Context context, List<Character> resource) {
