...
import adriengervais.dandy.activities.fragments.CharacterDetailDetailFragment;
 ...
 * more than a {@link adriengervais.dandy.activities.fragments.CharacterDetailDetailFragment}.
 */
public class CharacterDetailDetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(CharacterDetailDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(CharacterDetailDetailFragment.ARG_ITEM_ID));
            CharacterDetailDetailFragment fragment = new CharacterDetailDetailFragment();
            fragment.setArguments(arguments);
            getFragmentManager().beginTransaction()
                    .add(R.id.characterdetail_detail_container, fragment)
                    .commit();
        }
    }
