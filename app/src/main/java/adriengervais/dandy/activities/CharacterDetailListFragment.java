...
import adriengervais.dandy.activities.dummy.DetailsListContent;

/**
 * A list fragment representing a list of CharacterDetails. This fragment
 * also supports tablet devices by allowing list items to be given an
 * 'activated' state upon selection. This helps indicate which item is
 * currently being viewed in a {@link adriengervais.dandy.activities.fragments.CharacterDetailDetailFragment}.
 * <p/>
 * Activities containing this fragment MUST implement the {@link Callbacks}
 * interface.
 */
public class CharacterDetailListFragment extends ListFragment {
     ...
     * changes).
     */
    public CharacterDetailListFragment() {}
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new ArrayAdapter<DetailsListContent.DetailsListItem>(getActivity(),
                android.R.layout.simple_list_item_activated_1,
                android.R.id.text1,
                DetailsListContent.ITEMS));
    }
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(DetailsListContent.ITEMS.get(position).id);
    }
